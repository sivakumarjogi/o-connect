...
class FileEncryptionHelper {
  static const String ENCRYPTION_KEY = "ocnt-upload";
  static String encryptAESCryptoJS(String plainText) {
    try {
      final salt = genRandomWithNonZero(8);
      var keyndIV = deriveKeyAndIV(salt);
  ...
  static Tuple2<Uint8List, Uint8List> deriveKeyAndIV(Uint8List salt) {
    var password = createUint8ListFromString(ENCRYPTION_KEY);
