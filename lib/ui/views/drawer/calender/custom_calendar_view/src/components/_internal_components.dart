...
import 'package:o_connect/ui/views/drawer/calender/custom_calendar_view/src/painters.dart';
...
class LiveTimeIndicator extends StatefulWidget {
  ...
  /// Widget to display tile line according to current time.
  const LiveTimeIndicator({Key? key, required this.width, required this.height, required this.timeLineWidth, required this.liveTimeIndicatorSettings, required this.heightPerMinute}) : super(key: key);
        ...
        child: GestureDetector(
          ...
          child: Builder(builder: (context) {
            ...
            return eventTileBuilder(
              date,
              events[index].events,
              Rect.fromLTWH(events[index].left, events[index].top, width - events[index].right - events[index].left, height - events[index].bottom - events[index].top),
