...
class FilledCell<T extends Object?> extends StatelessWidget {
  ...
  /// Called when user taps on the cell which contains events.
      ...
      child: Stack(
        children: [
          if (events.isNotEmpty)
            GestureDetector(
              onTap: () => onCellTap?.call(events, events.first.date),
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: Text('${events.length - 1}', style: w300_12Poppins(color: Theme.of(context).primaryColorLight)),
                                ),
                              ),
                            ),
                        ],
                    ...
                    Text(events.first.name, maxLines: 1, overflow: TextOverflow.ellipsis),
                    Text(
                      "${DateFormat("dd MMM").format(events.first.startTime).toString()} , "
      ...
      child: Text(
        ...
        style: textStyle ??
            TextStyle(
                ...
                color: DateFormat('EEEE').format(DateTime.now()).contains(Constants.weekTitles[dayIndex]) ? AppColors.mainBlueColor : LightThemeColors.greyTextColor),
      ),
    );
  }
}
...
extension _DateTimeX on DateTime {
  String get toUiTime => DateFormat("hh:mm aa").format(this);
}
