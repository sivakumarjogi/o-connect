...
class WeekPageHeader extends CalendarPageHeader {
  ...
  const WeekPageHeader({
    ...
    HeaderStyle headerStyle = const HeaderStyle(),
          ...
          dateStringBuilder: headerStringBuilder ?? WeekPageHeader._weekStringBuilder,
          headerStyle: headerStyle,
        );

  static String _weekStringBuilder(DateTime date, {DateTime? secondaryDate}) => "${date.day} / ${date.month} / ${date.year} to "
