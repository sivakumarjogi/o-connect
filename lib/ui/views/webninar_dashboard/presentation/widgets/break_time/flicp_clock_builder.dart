...
import 'package:o_connect/ui/views/webninar_dashboard/presentation/widgets/break_time/flip_widget.dart';
...
class FlipClockBuilder {
  ...
  // Widget _buildTensDisplay(Stream<int> timePartStream, int initialValue) => _buildDisplay(
  ...
  Widget _digitBuilder(BuildContext context, int? digit) {
    return Container(
