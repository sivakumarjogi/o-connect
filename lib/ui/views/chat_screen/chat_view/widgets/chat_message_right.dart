...
class ChatMessageRight extends StatelessWidget with MeetingUtilsMixin {
  ChatMessageRight({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Consumer3<ThemeProvider, ChatProvider, WebinarThemesProviders>(
        builder: (context, themeProvider, chatProvider, webinarThemesProviders,
            child) {
      var messageColor = Colors.blue;
      var replyMessage = [];
      List<ChatModel> selectQAndAMessage = [];
          ...
          children: [
            ...
            Column(
              ...
              children: [
                        ...
                        : Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Visibility(
                                  visible: messageData.message == null ||
                                          messageData.message == ""
                                      ? false
                                      : true,
                                  child: Column(
                ...
                Padding(
                  padding: EdgeInsets.only(top: 3.0.sp, left: 15.sp),
                  child: Text(
                    DateFormat("HH:mm")
            ...
            width5,
            Padding(
              padding: EdgeInsets.only(top: 2.sp, left: 3.sp),
