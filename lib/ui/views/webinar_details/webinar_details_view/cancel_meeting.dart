...
class CancelMeetingPopup extends StatefulWidget {
  const CancelMeetingPopup({super.key, required this.dataList});

  final MeetingDetailsModel dataList;

  @override
  State<CancelMeetingPopup> createState() => _CancelMeetingPopupState();
}

class _CancelMeetingPopupState extends State<CancelMeetingPopup> {
                              ...
                              onTap: () {
                                ...
                                if (_key.currentState!.validate()) {
                                  homeScreenProvider.deleteMeeting(
                                      meetingId: widget.dataList.id.toString(), userName: widget.dataList.userEmail.toString(), reason: cancelMeetingController.text, context: context);
                                  // Navigator.pop(context);
                                }
                                //
                              })
