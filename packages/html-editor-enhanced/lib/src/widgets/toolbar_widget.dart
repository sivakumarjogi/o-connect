...
class ToolbarWidgetState extends State<ToolbarWidget> {
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (kIsWeb) {
                                      ...
                                      await widget.controller.editorController!
                                          .evaluateJavascript(source: "var height = \$('div.note-editable').outerHeight(true); window.flutter_inappwebview.callHandler('setHeight', height);");
                                    }
                                  },
                                ),
                              )),
  ...
  List<Widget> _buildChildren() {
        ...
        toolbarChildren.add(Container(
          ...
          child: CustomDropdownButtonHideUnderline(
            child: CustomDropdownButton<String>(
              ...
              menuDirection:
                  widget.htmlToolbarOptions.dropdownMenuDirection ?? (widget.htmlToolbarOptions.toolbarPosition == ToolbarPosition.belowEditor ? DropdownMenuDirection.up : DropdownMenuDirection.down),
      ...
      if (t is FontSettingButtons) {
        if (t.fontName) {
          toolbarChildren.add(Container(
            padding: const EdgeInsets.only(left: 8.0),
            height: widget.htmlToolbarOptions.toolbarItemHeight,
            decoration: BoxDecoration(border: Border.all(color: Colors.grey.shade800), color: Color(0x0C0D0E), borderRadius: BorderRadius.circular(5 ?? 5)),
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                elevation: widget.htmlToolbarOptions.dropdownElevation,
                icon: widget.htmlToolbarOptions.dropdownIcon,
      ...
      if (t is FontButtons) {
        if (t.bold || t.italic || t.underline || t.clearAll) {
          toolbarChildren.add(ToggleButtons(
            ...
            fillColor: Color(0xff08174d),
            focusColor: Color(0xff08174d),
            highlightColor: Color(0xff08174d),
            hoverColor: Color(0xff08174d),
                      ...
                      return PointerInterceptor(
                        child: AlertDialog(
                          ...
                          content: ColorPicker(
                            ...
                            title: Text('Choose a Color', style: Theme.of(context).textTheme.titleLarge),
                            width: 40,
                            height: 40,
                            spacing: 0,
                            runSpacing: 0,
                          ...
                          return AlertDialog(
                            ...
                            content: Form(
                              ...
                              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Text('Text to display', style: TextStyle(color: Theme.of(context).hintColor)),
                                SizedBox(height: 10),
                                TextField(
                                  controller: text,
                                  focusNode: textFocus,
                                ...
                                SizedBox(height: 20),
                                Text('URL', style: TextStyle(color: Theme.of(context).hintColor)),
                                SizedBox(height: 10),
                                TextFormField(
                                  controller: url,
                                  focusNode: urlFocus,
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (formKey.currentState!.validate()) {
                                    var proceed = await widget.htmlToolbarOptions.linkInsertInterceptor?.call(
                                ...
                                TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      prefixIcon: ElevatedButton(
                                        style: ElevatedButton.styleFrom(backgroundColor: Theme.of(context).dialogBackgroundColor, padding: EdgeInsets.only(left: 5, right: 5), elevation: 0.0),
                                        onPressed: () async {
                                        ...
                                        child: Text('Choose image', style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color)),
                                      ),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    setState(() {
                                      validateFailed = widget.htmlToolbarOptions.allowImagePicking ? 'Please either choose an image or enter an image URL!' : 'Please enter an image URL!';
                                    });
                                    ...
                                    if (proceed) {
                                      widget.controller.insertHtml("<img src='data:image/${result!.files.single.extension};base64,$base64Data' data-filename='${result!.files.single.name}'/>");
                                    }
                                    Navigator.of(context).pop();
                                  } else {
                              ...
                              TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    prefixIcon: ElevatedButton(
                                      ...
                                      child: Text('Choose audio', style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color)),
                                    ),
                                    suffixIcon: result != null
                                        ? IconButton(
                                            icon: Icon(Icons.close),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    if (proceed) {
                                      widget.controller
                                          .insertHtml("<audio controls src='data:audio/${result!.files.single.extension};base64,$base64Data' data-filename='${result!.files.single.name}'></audio>");
                                    }
                                    Navigator.of(context).pop();
                                  } else {
                              ...
                              TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    prefixIcon: ElevatedButton(
                                      ...
                                      child: Text('Choose video', style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color)),
                                    ),
                                    suffixIcon: result != null
                                        ? IconButton(
                                            icon: Icon(Icons.close),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    if (proceed) {
                                      widget.controller
                                          .insertHtml("<video controls src='data:video/${result!.files.single.extension};base64,$base64Data' data-filename='${result!.files.single.name}'></video>");
                                    }
                                    Navigator.of(context).pop();
                                  } else {
                              ...
                              TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    prefixIcon: ElevatedButton(
                                      ...
                                      child: Text('Choose file', style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color)),
                                    ),
                                    suffixIcon: result != null
                                        ? IconButton(
                                            icon: Icon(Icons.close),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (kIsWeb) {
                                    ...
                                    await widget.controller.editorController!.evaluateJavascript(source: "\$('#summernote-2').summernote('insertTable', '${currentRows}x$currentCols');");
                                  }
                                  Navigator.of(context).pop();
                                },
                                child: Text('OK'),
    ...
    if (widget.htmlToolbarOptions.customToolbarInsertionIndices.isNotEmpty && widget.htmlToolbarOptions.customToolbarInsertionIndices.length == widget.htmlToolbarOptions.customToolbarButtons.length) {
